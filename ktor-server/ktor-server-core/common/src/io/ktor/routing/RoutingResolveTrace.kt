...
public open class RoutingResolveTraceEntry(
     ...
     */
    private var children: MutableList<RoutingResolveTraceEntry>? by shared(null) //TODO needed?

    /**
     * Appends a child to this entry
     */
    public fun append(item: RoutingResolveTraceEntry) {
        val items = children ?: sharedList<RoutingResolveTraceEntry>().also { children = it }  //TODO needed?
        items.add(item)
    }
...
private class Stack<E> {
    private val tower = sharedList<E>() //TODO needed?
