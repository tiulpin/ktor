...
class CallIdTest {
    @Test
    fun missingFeature() = testSuspend {
        withTestApplication {
            handle {
    ...
    @Test
    fun customRetriever() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun headerRetriever() = testSuspend {
        withTestApplication {
            application.install(CallId) {
    ...
    @Test
    fun headerRetrieverWithGenerator() = testSuspend {
        withTestApplication {
            application.install(CallId) {
                retrieveFromHeader(HttpHeaders.XRequestId)
                generate {
    ...
    @Test
    fun headerRetrieverWithTextGenerator() = testSuspend {
        withTestApplication {
            val dictionary = "abc"
            val length = 64
    ...
    @Test
    fun headerRetrieverWithDefaultTextGenerator() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testDefaultVerifierForRetrieve() = testSuspend {
        withTestApplication {
            application.install(CallId) {
                header(HttpHeaders.XRequestId)
            }
    ...
    @Test
    fun testDefaultVerifierForGenerate() = testSuspend {
        withTestApplication {
            application.install(CallId) {
    ...
    @Test
    fun testCustomVerifier() = testSuspend {
        withTestApplication {
            application.install(CallId) {
                header(HttpHeaders.XRequestId)
