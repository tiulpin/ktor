...
class StaticContentTest {
    ...
    @Test
    fun testStaticContentBuilder() = testSuspend {
        withTestApplication {
            application.routing {
                static("files") {
                    files(basedir)
    ...
    @Test
    fun testStaticContent() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testStaticContentWrongPath() = testSuspend {
        withTestApplication {
            application.routing {
                static {
                    files(basedir)
    ...
    @Test
    fun testServeEncodedFileBr() = testSuspend {
        withTestApplication {
            val ext = "json"
    ...
    @Test
    fun testServeEncodedFileGz() = testSuspend {
        withTestApplication {
            val ext = "js"
    ...
    fun testSuppressCompressionIfAlreadyCompressed() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testCompressedTypesOrder() = testSuspend {
        withTestApplication {
            val ext = "js"
    ...
    @Test
    fun testPreCompressedConfiguresImperatively() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testPreCompressedConfiguresNested() = testSuspend {
        withTestApplication {
            val tempFile = File.createTempFile("testServeEncodedFile", ".dummy")
            val publicFile = tempFile.nameWithoutExtension
    ...
    @Test
    fun testSendLocalFile() = testSuspend {
        withTestApplication {
    ...
    @Test
    fun testSendLocalFilePaths() = testSuspend {
        withTestApplication {
            application.intercept(ApplicationCallPipeline.Call) {
                call.respond(
                    LocalFileContent(
    ...
    @Test
    fun testSendLocalFileBadRelative() = testSuspend {
        withTestApplication {
            application.intercept(ApplicationCallPipeline.Call) {
    ...
    @Test
    fun testSendLocalFileBadRelativePaths() = testSuspend {
        withTestApplication {
            application.intercept(ApplicationCallPipeline.Call) {
                assertFailsWithSuspended<Exception> {
                    call.respond(
    ...
    @Test
    fun testInterceptCacheControl() = testSuspend {
        withTestApplication {
